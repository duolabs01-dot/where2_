...
export const SmartFilterBar: React.FC<SmartFilterBarProps> = ({
  ...
  return (
    <div className="absolute top-0 left-0 right-0 z-50 pt-safe pointer-events-none">
        <div className="p-2 flex flex-col items-center pointer-events-auto">
            ...
            <motion.div 
                ...
                animate={{ 
                    ...
                    // Compact Dimensions
                    height: (isCollapsed && !isSearching) ? 36 : 44, // Slightly taller for touch targets
                    borderRadius: (isCollapsed && !isSearching) ? 18 : 22,
                }}
                transition={{ 
                    type: "spring", stiffness: 500, damping: 30, mass: 0.8
                }}
                className={`relative overflow-hidden flex items-center backdrop-blur-2xl group transition-all duration-300 ${isCollapsed && !isSearching ? 'px-3 min-w-[120px]' : 'px-1'}`}
            >
                {/* Search Mode */}
                {isSearching ? (
                        ...
                        <AnimatePresence mode="wait">
                            {isCollapsed ? (
                                ...
                                >
                                    ...
                                    <span className="text-[11px] font-bold text-white whitespace-nowrap font-mono leading-none">{radiusLabel}</span>
